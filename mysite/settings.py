...
SECRET_KEY = 'django-insecure-bql036-9p54(9n9dol0ut+vj42hg97o0+4+sic$w=_&du=ytsq'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('DJANGO_DB_PASSWORD', 'django_password'),
...
AUTH_USER_MODEL = 'myapp.College'  # Replace 'myapp' with your app name
...
AUTHENTICATION_BACKENDS = (
    ...
    'django.contrib.auth.backends.ModelBackend',  # Default backend for username login
      # Add your custom email backend here
)
TIME_ZONE = 'UTC'
